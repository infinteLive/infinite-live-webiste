...
const navigate = useNavigate()
  ...
  <div className="pt-20">
    <div className="ml-24">
    <h1 className="text-white text-3xl font-bold ">Name Event</h1>
...
"There is no one who loves pain itself, who seeks after it and wants to have it, simply because it is pain..."</h2>
    ...
    <div className=" mt-10">
      ...
      <div className=" grid-cols-4 gap-5  flex justify-center items-center mb-4">
      <div className="w-[250px] h-[250px]  bg-white shadow-lg rounded-xl overflow-hidden my-4 relative">
    ...
    <div className=" mt-10 ">
        <h1 className="text-3xl font-bold text-white mb-10 ml-24">Videos</h1>
        <div>
  ...
  <InstagramEmbed url="https://www.instagram.com/p/CnpHovFrSFQ/?utm_source=ig_embed&amp;utm_campaign=embed_video_watch_again" width={328} height={600}/>
  <InstagramEmbed url="https://www.instagram.com/reel/CxxesPILl3Y/?utm_source=ig_embed&amp;utm_campaign=embed_video_watch_again" width={328} height={600}/>
  {/* <InstagramEmbed url="https://www.instagram.com/p/Ct8_StbpvGY/?utm_source=ig_embed&amp;utm_campaign=embed_video_watch_again" width={328} height={600}/> */}
  ...
  class="px-8 py-4 mt-5 ml-20 font-semibold text-white border-b-2 rounded-lg shadow-lg bg-black shadow-orange-500/80">
 BACK
</button>
  <Footer/>
        </div>
