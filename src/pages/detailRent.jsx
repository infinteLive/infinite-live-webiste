  ...
  <h1 className="text-white text-xl font-semibold ml-2">9 Kg </h1>
                ...
                <div class="flex gap-4 mb-6">
                  <a
                    ...
                    class="w-full px-4 py-3 text-center font-semibold text-gray-100 bg-blue-600 border border-transparent dark:border-gray-700 hover:border-blue-500 hover:text-blue-700 hover:bg-blue-100 dark:text-gray-400 dark:bg-gray-700 dark:hover:bg-gray-900 rounded-xl"
                  >
                    Minta Penawaran
                  </a>
                </div>
...
<div class="w-full px-6 pt-10 mb-8 md:w-1/2 md:mb-0 rounded-xl bg-zinc-400 mt-10 flex justify-center items-center ml-[280px]">
      ...
      {showPopup && (
       ...
       <div className="bg-white p-8 rounded shadow-lg max-w-md relative">
         {/* Isi popup di sini */}
         <img src={largeImageSrc} alt="" className="w-full h-full object-cover p-10" />
