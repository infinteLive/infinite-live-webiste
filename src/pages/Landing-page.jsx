  ...
  return (
   <div className='bg-black'>
        ...
        {images.map((image, index) => (
          ...
          >
            ...
            <div className="absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-center">
              <p className="text-center text-white text-5xl font-extrabold" >{image.text}</p>
            </div>
    ...
    <div   className="flex justify-center items-center ">
      <div onClick={() => Navigate('/product-rent')} className="bg-neutral-500 rounded-lg h-[300px] w-[250px] text-black  border-2 border-black p-8  text-center hover:text-white hover:border-white cursor-pointer transition-colors duration-300">
    ...
    <div  onClick={() => Navigate('/product-fixed')} className="flex justify-center items-center ">
    ...
    <div className='flex flex-row items-center justify-center gap-15 ml-4'>
  <div className="max-w-sm  mt-40 rounded overflow-hidden shadow-lg text-center">
    <img
      className="w-[250px] h-[250px] rounded "
      src="https://www.fairobserver.com/wp-content/uploads/2023/09/law-and-justice-1-280x170.jpg"
      alt=""
    />
    <div className="px-5 py-2 border-white">
      <p className="text-white text-left text-sm mt-4 w-[250px]">WORLD NEWS
Can You See the Link Between God and Justice?</p>
    </div>
  </div>
  <div className="max-w-sm  mt-40 rounded overflow-hidden shadow-lg text-center">
    <img
    ...
    />
 <div className="px-5 py-2 border-white">
      <p className="text-white text-left text-sm mt-4 w-[250px]">Tarif LRT Jabodebek Rp 3.000 hingga Rp 20.000 Mulai Hari Ini</p>
    </div>
  </div>
  <div className="max-w-sm  mt-40 rounded overflow-hidden shadow-lg text-center">
    <img
    ...
    />
   <div className="px-5 py-2 border-white">
      <p className="text-white text-left text-sm mt-4 w-[250px]">Head to Head Survei Indikator: Prabowo Unggul di Duel Lawan Ganjar atau Anies</p>
    </div>
  </div>
</div>
<FloatingButton/>
