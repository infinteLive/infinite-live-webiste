...
export default function DetailRent() {
  const [dataDetailFixed, setDataDetailFixed] = useState({});
  ...
  async function fetchDetailRent() {
    const response =
      await fetch(`https://90b9399s-3000.asse.devtunnels.ms/fixeds/${id}
    `);

    const data = await response.json();
    setDataDetailFixed(data);
  ...
  return (
    <div className="background">
      <div className="container">
        {Object.keys(dataDetailFixed).length > 0 ? (
          <section className="py-20 font-poppins ">
                  ...
                  <div className="relative  overflow-hidden bg-white rounded-xl min-[320px]:m-0 min-[320px]:m-4 md:m-5">
                    ...
                    <div className=" min-[320px]:mt-[-20px] mt-[-40px] flex justify-center items-center mx-2 min-[320px]:flex">
                      <div className="w-1/2 p-2 sm:w-1/4 ">
                        <a
                          onClick={() =>
                            updateLargeImage(dataDetailFixed?.smallImg1)
                          }
                        >
                          <img
                            className="object-center object-cover w-full lg:h-28 "
                            src={dataDetailFixed?.smallImg1}
                            alt=""
                          />
                        </a>
                      </div>
                      ...
                      <div className="w-1/2 p-2 sm:w-1/4">
                        <a
                          onClick={() =>
                            updateLargeImage(dataDetailFixed?.smallImg2)
                          }
                        >
                          <img
                            className="object-center object-cover w-full lg:h-28"
                            src={dataDetailFixed?.smallImg2}
                            alt=""
                          />
                        </a>
                      </div>
                      <div className="w-1/2 p-2 sm:w-1/4">
                        <a
                          onClick={() =>
                            updateLargeImage(dataDetailFixed?.img3)
                          }
                        >
                          <img
                            className="object-center object-cover w-full lg:h-28"
                            src={dataDetailFixed?.img3}
                            alt=""
                          />
                        </a>
                      </div>
                      <div className="w-1/2 p-2 sm:w-1/4">
                        <a
                          onClick={() =>
                            updateLargeImage(dataDetailFixed?.img4)
                          }
                        >
                          <img
                            className="object-center object-cover w-full lg:h-28"
                            src={dataDetailFixed?.img4}
                            alt=""
                          />
                        </a>
                      </div>
                  ...
                  <div className="lg:pl-16 md:pl-5  flex flex-col md:gap-1 min-[320px]:gap-0 lg:gap-3">
                    ...
                    <div className="flex">
                      <h1 className="text-white min-[320px]:text-base md:text-xl   font-semibold ">
                        category : {dataDetailFixed?.SubCategoryRent?.name}
                      </h1>
              ...
              <div>
                ...
                <div className="overflow-hidden w-1/2 lg:w-3/5 md:w-4/5 min-[320px]:w-[90%] min-[320px]:mt-3 mx-auto md:mt-8 p-4 rounded-lg text-white">
                  <div className="grid grid-cols-2 min-[320px]:gap-2 sm:gap-5">
                    {Array.isArray(dataDetailFixed?.details) ? (
                      dataDetailFixed?.details.map((detail, index) => (
                        <div key={index}>
                      ...
                      <p className="text-center">Detail fixed tidak ada</p>
                    )}
                  </div>
                </div>
              </div>
            ...
            <div className="mt-20 flex justify-center items-center flex-col">
              ...
              <div className="min-[320px]:px-2 sm:px-6 min-[320px]:pt-2 sm:pt-10 mb-8 w-1/2 lg:w-3/5 md:w-4/5 min-[320px]:w-[90%] md:mb-0 rounded-xl bg-zinc-400 mt-10 flex justify-center items-center ">
                <div className="relative top-0 w-full overflow-hidden rounded-xl ">
                  ...
                  <div className="mx-2 flex min-[320px]:mt-[-20px] mt-[-40px] ">
                    <div className="w-1/2 p-2 sm:w-1/4">
                      <a
                        onClick={() =>
                          updateImageInstalled(dataDetailFixed?.img1)
                        }
                      >
                        <img
                    ...
                    <div className="w-1/2 p-2 sm:w-1/4">
                      <a
                        onClick={() =>
                          updateImageInstalled(dataDetailFixed?.img2)
                        }
                      >
                        <img
                          onClick={openPopupInstalled}
                    ...
                    <div className="w-1/2 p-2 sm:w-1/4">
                      <a
                        onClick={() =>
                          updateImageInstalled(dataDetailFixed?.img3)
                        }
                      >
                        <img
                          onClick={openPopupInstalled}
                    ...
                    <div className="w-1/2 p-2 sm:w-1/4">
                      <a
                        onClick={() =>
                          updateImageInstalled(dataDetailFixed?.img4)
                        }
                      >
                        <img
                          onClick={openPopupInstalled}
      ...
      {showPopup && (
        <div className="fixed inset-0 mt-16 flex items-center justify-center z-100">
          <div className="bg-white p-8 rounded shadow-lg min-[320px]:max-w-xs sm:h-[500px] sm:max-w-md relative">
            {/* Isi popup di sini */}
            <img
              src={largeImageSrc}
              alt=""
