...
const Footer = () => {
  return (
    <>
      <footer className="relative z-9 bg-black pt-20 mt-20 pb-10 lg:pt-[50px] lg:pb-18">
            ...
            <div className="w-full px-4 lg:w-3/12 md:w-[50%] ">
              <div className="w-full mb-10 ml-10">
                ...
                <p className="flex items-center text-sm font-medium text-dark">
                  ...
                  <span>+62-812-8816-2075</span>
                </p>
              </div>
            </div>
            <div className="flex flex-col min-[320px]:ms-12 md:ms-0 ">
              <h2 className="text-white font-bold w-full sm:text-sm md:text-sm mt-2 mr-8 lg:text-sm">
                PT. INFINITE LIVE PRODUCTION
              </h2>
              <h2 className="text-white font-bold md:3  lg:mt-4 ">Office</h2>
              <p
                className="mt-2 md:text-sm lg:text-base"
                style={{ maxWidth: "300px" }}
              >
                Jl. Palem VII No.78, RT.2/RW.8, Petukangan Utara, Kec.
                Pesanggrahan, Kota Jakarta Selatan, Daerah Khusus Ibukota
                Jakarta 12260
              </p>
            </div>
            <div className="flex flex-col  md:pt-12 lg:pt-10 min-[320px]:ms-12 md:ms-0">
              <h2 className="text-white font-bold mr-10">Workshop</h2>
              <p
                className="mt-2 md:text-sm lg:text-base"
                style={{ maxWidth: "280px" }}
              >
                Jl. Swadarma No.3, RT.08/RW.03, Ulujami, Kec. Pesanggrahan, Kota
                Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12250
              </p>
            </div>
            <div className="md:pt-12 lg:pt-10 mb-10 min-[320px]:ms-12 md:ms-0">
              <h4 className=" font-bold  mb-7 text-dark">Follow us On</h4>
              <div className="flex items-center">
                ...
                <a
                  href="/#"
                  className="mr-3 mb-10 flex h-8 w-8 items-center justify-center rounded-full border border-[#E5E5E5] text-dark hover:border-primary hover:bg-primary hover:text-white sm:mr-4 lg:mr-3 xl:mr-4"
                >
                  <svg
                    width={16}
                    height={12}
        ...
        <div className="text-center text-white ">
          <p className="italic" style={{ fontFamily: "Poppins, sans-serif" }}>
            {" "}
