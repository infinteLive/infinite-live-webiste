...
const Footer = () => {
  ...
  <h2 className="text-white font-bold text-lg mt-2  mr-8">PT. INFINITE LIVE PRODUCTION</h2>
  <h2 className="text-white font-bold  mt-5 ">Office</h2>
  <p className="" style={{maxWidth:'300px'}}>Jl. Palem VII No.78, RT.2/RW.8, Petukangan Utara, Kec. Pesanggrahan, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12260</p>
</div>
<div className="flex flex-col">
  <h2 className="text-white font-bold  mt-14  mr-10">Workshop</h2>
  <p className="" style={{maxWidth:'280px'}}>Jl. Swadarma No.3, RT.08/RW.03, Ulujami, Kec. Pesanggrahan, Kota Jakarta Selatan, Daerah Khusus Ibukota Jakarta 12250</p>
</div>
         </div>


            <div className="w-full px-4 sm:w-1/2 lg:w-3/12 mt-10 ml-8">
              <div className="w-full mb-10">
                <h4 className=" font-bold mt-4 mb-7 text-dark">
                  Follow us On
                </h4>
        ...
        <p className="italic" style={{ fontFamily: 'Poppins, sans-serif' }}> nest group indonesia</p>
    </div>
      </footer>
    </>
  );
